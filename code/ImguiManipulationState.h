...
namespace BBIT
{
	enum class STEP_ID2
	{
		...
		ARM_FOREARM_RIGHT_LATERAL,
		ARM_FOREARM_RIGHT_MEDIAL,
		ARM_UPPER_LEFT_LATERAL,
		ARM_UPPER_LEFT_MEDIAL,
		ARM_FOREARM_LEFT_LATERAL,
		ARM_FOREARM_LEFT_MEDIAL,
		BREAST_R_ANATOMIC,
		BREAST_L_ANATOMIC,
		WAIST_R_ANATOMIC,
		WAIST_L_ANATOMIC,
	...
	class ImguiManipulationState
	{
	public:
		ImguiManipulationState();
		~ImguiManipulationState();
	...
	private:
		...
		ImGuiWindowFlags manip_panel_flags = 0;
		...
		void showMainMenuBar(bool* p_open);
